...
public class AirportTest {
    ...
    public void testGetTransportMilitaryPlanes() {
        ...
        boolean flag = false; //no need in "flag"
        //can be rewriten
...
//         Assert.assertEquals(expectedPlaneWithMaxPassengersCapacity, planeWithMaxPassengerCapacity);
    ...
    public void test3() {
        ...
        boolean nextPlaneMaxLoadCapacityIsHigherThanCurrent = true; //no need
    ...
    public void testHasAtLeastOneBomberInMilitaryPlanes() {
        ...
        for (MilitaryPlane militaryPlane : bomberMilitaryPlanes) {
            if ((militaryPlane.getType() == MilitaryType.BOMBER)) {
                ...
                Assert.fail("Test failed!"); //NO NEED
            }
        }
        // if not failed
        //for example
...
//         }
    ...
    @Test
    public void testExperimentalPlanesHasClassificationLevelHigherThanUnclassified(){ //strange name
        Airport airport = new Airport(planes);
